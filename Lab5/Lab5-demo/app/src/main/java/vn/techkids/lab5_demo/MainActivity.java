...
import vn.techkids.lab5_demo.fragments.ArticleFragment;
import vn.techkids.lab5_demo.fragments.PaymentFragment;
import vn.techkids.lab5_demo.fragments.SettingFragment;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        boolean set = super.onPrepareOptionsMenu(menu);
    ...
    public void setTogleBar(Boolean visible){
        if (visible){
            Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
            setSupportActionBar(toolbar);
